...
class MetaLearner(ABC):
    def __init__(self):
        ...
        self._batch_outer_loss = eqx.filter_jit(
    ...
    def train_step(self, params, state, train, test, args):
        outer_loss_grad = eqx.filter_value_and_grad(self.batch_outer_loss, has_aux=True)
    ...
    def _step(self):
        if self._train_step is None:
            self._train_step = eqx.filter_jit(self.train_step, static_argnums=(4,))
